...
#tkinter.Label(grid_frame_1, text='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').grid(row=3, column=0)

#Grid 2 Layout
tkinter.Label(grid_frame_2, text='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa').grid(row=3, column=0)
